...
class MYPDF extends TCPDF {
    ...
    public function ColoredTable($header, $data, $conn) {
        ...
        // Set column widths
        $w = array(110, 80, 80); // Adjusted widths for ID, Name, and Role
        ...
        foreach ($data as $row) {
            ...
            $this->Cell($w[1], 6, $row['image'], 'LR', 0, 'L', $fill);
            $this->Cell($w[2], 6, $row['publish'], 'LR', 0, 'L', $fill);
            $this->Ln();
            $fill = !$fill;
        }
...
// column titles
$header = array('GAME TITLE', 'DESCRIPTION', 'PUBLISH DATE');
