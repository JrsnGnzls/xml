...
class MYPDF extends TCPDF {
    ...
    public function ColoredTable($header, $data, $conn) {
        ...
        // Set column widths
        $w = array(130, 30, 70, 40); // Adjusted widths for ID, Name, and Role
        ...
        foreach ($data as $row) {
            ...
            $title_query = "SELECT title FROM tbl_news WHERE id = '{$row['item_id']}'";
            ...
            $this->Cell($w[2], 6, $row['comment'], 'LR', 0, 'L', $fill);
...
// column titles
$header = array('GAME TITLE', 'NAME', 'COMMENT', 'CREATED_AT');
