...
class MYPDF extends TCPDF {
    ...
    public function ColoredTable($header, $data) {
        ...
        // Set column widths
        $w = array(10, 80, 60, 30); // Adjusted widths for ID, Name, and Role
        ...
        foreach ($data as $row) {
            ...
            $this->Cell($w[3], 6, $role, 'LR', 0, 'L', $fill);
            $this->Ln();
            $fill = !$fill;
        }
...
$pdf->SetCreator('Jefferson Gonzales');
$pdf->SetAuthor('B.S. in Information System');
...
// column titles
$header = array('ID','EMAIL', 'NAME', 'ROLE');
