<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="comment-list.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="favorites.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa fa-heart text-dark text-lg"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="ratings.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa fa-star-o text-dark text-lg"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="rated_games.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa fa-star text-dark text-lg"></i>
            </div>
            <span class="nav-link-text ms-1">Rated Games</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="rss.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa fa-rss text-dark text-lg"></i>
            </div>
            <span class="nav-link-text ms-1">RSS</span>
          </a>
        </li>
